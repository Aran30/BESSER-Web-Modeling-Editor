...
The BESSER Web Modeling Editor (BESSER WME) is a UML modeling editor which can be used to visualize and
...
.. figure:: model.png
   ...
   BESSER WME Data Model

The above diagram illustrates the Data Model of BESSER WME.
...
In BESSER WME exist two libraries to manage side effects of actions. `Redux thunk <https://github.com/reduxjs/redux-thunk>`_ and `Redux-Saga <https://github.com/redux-saga/redux-saga>` are middlewares for Redux.
...
* | for performance reasons, we only do shallow copies of the data, see `Performance <https://www.typescriptlang.org/docs/handbook/release-notes/typescript-3-2.html#generic-spread-expressions-in-object-literals>`_ ->
  | in BESSER WME shallow copies are often created, using the `typescript spread expression <https://www.typescriptlang.org/docs/handbook/release-notes/typescript-3-2.html#generic-spread-expressions-in-object-literals>`_.

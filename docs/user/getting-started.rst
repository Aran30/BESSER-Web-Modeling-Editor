...
BESSER Web Modeling Editor (BESSER WME) is a UML modeling editor written in React and TypeScript.
...
Get hold of a DOM node and mount a new instance of the BESSER WME editor into it:

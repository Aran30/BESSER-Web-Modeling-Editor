...
import ReplyUpdate from '../reply-body/reply-body-update';
...
class StateUpdate extends Component<Props, State> {
  ...
  render() {
    ...
    const bodies = children.filter((child) => child instanceof ReplyBody);
      ...
      <div>
        ...
        <section>
          ...
          <Textfield
            ...
            outline
            value=""
            onSubmit={this.create(ReplyBody)}
  ...
  private create = (Clazz: typeof ReplyBody) => (value: string) => {
...
export const ReplyBodyUpdate = enhance(StateUpdate);
...
function connectWebSocket(wsAddress) {
    ...
    ws.onopen = () => {
        ...
        // Optionally show chat UI here
    };
    ws.onclose = () => {
        console.log('Disconnected from WebSocket server, retrying in 1s...');
        if (loading) loading.style.display = 'flex';
        setTimeout(connectWebSocket(wsAddress), 1000);
    };
    ws.onerror = (error) => {
...
function renderChatWidget(args) {
  ...
  <div id="chat-window">
    <div id="chat-loading" style="display: flex; align-items: center; justify-content: center; height: 100%;">
      <div class="spinner"></div>
      <span style="margin-left: 10px;">Connecting...</span>
    </div>
